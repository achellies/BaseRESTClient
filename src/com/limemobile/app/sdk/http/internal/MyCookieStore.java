...
import com.wanda.ads.util.Strings;
 ...
 */
public class MyCookieStore extends CookieHandler implements CookieStore {
    ...
    public Map<String, List<String>> get(URI uri,
        ...
        return singletonMap(SM.COOKIE,
                singletonList(Strings.join(cookies, SEP)));
    }
    ...
    public void addCookie(Cookie cookie) {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + name,
                encodeCookie(new ParcelCookie(cookie)));
        prefsWriter.commit();
    }
     ...
     */
    protected String encodeCookie(ParcelCookie cookie) {
        if (cookie == null)
            return null;
        ...
        return byteArrayToHexString(bytes);// byteArrayToHexString(os.toByteArray());
    }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        // cookie = ((ParcelCookie) objectInputStream.readObject())
        // .getCookie();
        // } catch (IOException e) {
        ...
        try {
            ...
            p.setDataPosition(0);
            ParcelCookie parcelCookie = (ParcelCookie) p
                    .readValue(ParcelCookie.class.getClassLoader());
            p.recycle();
            cookie = parcelCookie.getCookie();
        } catch (Exception e) {
        }
        return cookie;
    }
